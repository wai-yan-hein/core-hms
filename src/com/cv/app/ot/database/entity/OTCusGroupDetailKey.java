 ...
 */
@Embeddable
public class OTCusGroupDetailKey implements Serializable {
    private Integer cusGrpId;
    private OTProcedureGroup opdCatId;
    ...
    @JoinColumn(name="ot_cat_id")
    public OTProcedureGroup getOpdCatId() {
        return opdCatId;
    }

    public void setOpdCatId(OTProcedureGroup opdCatId) {
    ...
    public boolean equals(Object obj) {
        ...
        final OTCusGroupDetailKey other = (OTCusGroupDetailKey) obj;

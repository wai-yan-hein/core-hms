 ...
 */
@Embeddable
public class OTAutoAddIdMappingKey implements Serializable{
    private String tranOption;
    private Integer tranServiceId;
    private OTProcedure addServiceId;
    ...
    public OTProcedure getAddServiceId() {
        return addServiceId;
    }

    public void setAddServiceId(OTProcedure addServiceId) {
    ...
    public boolean equals(Object obj) {
        ...
        final OTAutoAddIdMappingKey other = (OTAutoAddIdMappingKey) obj;

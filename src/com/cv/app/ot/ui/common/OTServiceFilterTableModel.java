...
import com.cv.app.ot.database.tempentity.OTVouSrvFilterKey;
 ...
 * @author WSwe
 */
public class OTServiceFilterTableModel extends AbstractTableModel {

    static Logger log = Logger.getLogger(OTServiceFilterTableModel.class.getName());
    private List<OTVouSrvFilter> listVouSrvFilter = new ArrayList();
    private String[] columnNames = {"Description"};
    private AbstractDataAccess dao;
    private boolean insStatus = true; //Insert to the table
    private String modelOption;

    public OTServiceFilterTableModel(AbstractDataAccess dao, boolean insStatus, String modelOption) {
        this.dao = dao;
    ...
    public Object getValueAt(int row, int column) {
        OTVouSrvFilter record = listVouSrvFilter.get(row);
    ...
    public boolean hasEmptyRow() {
        ...
        OTVouSrvFilter record = listVouSrvFilter.get(listVouSrvFilter.size() - 1);
    ...
    public void addEmptyRow() {
        OTVouSrvFilter record = new OTVouSrvFilter();
    ...
    public void setVouSrvFilter(OTVouSrvFilter record, int pos) {
    ...
    public void setService(OTProcedure service, int row) {
        ...
        try {
            if (!JoSQLUtil.isAlreadyHave(strSQL, listVouSrvFilter)) {
                OTVouSrvFilter vsf = new OTVouSrvFilter(
                        new OTVouSrvFilterKey(modelOption, userId, service));
    ...
    public List<OTVouSrvFilter> getListVouSrvFilter() {
        return listVouSrvFilter;
    }

    public void setListVouSrvFilter(List<OTVouSrvFilter> listVouSrvFilter) {
    ...
    public String getFilterCodeStr() {
        ...
        for (OTVouSrvFilter code : listVouSrvFilter) {
            if (code.getKey() != null) {

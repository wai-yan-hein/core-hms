 ...
 * @author winswe
 */
public class OTDrFeeAutoCompleter implements KeyListener {
    static Logger log = Logger.getLogger(OTDrFeeAutoCompleter.class.getName());
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private OTDrFeeAutoCompleteTableModel acTableModel;
    private Doctor selService;
    private AbstractCellEditor editor;
    private TableRowSorter<TableModel> sorter;
    
    public OTDrFeeAutoCompleter(JTextComponent comp, List<Doctor> list,
            AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(Global.textFont);
        acTableModel = new OTDrFeeAutoCompleteTableModel(list);
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            OTDrFeeAutoCompleter completer = (OTDrFeeAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

            if (completer.table.getSelectedRow() != -1) {
                selService = acTableModel.getDoctor(completer.table.convertRowIndexToModel(

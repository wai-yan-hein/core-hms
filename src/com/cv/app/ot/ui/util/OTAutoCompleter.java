...
import com.cv.app.ot.ui.common.OTAutoCompleteTableModel;
 ...
 * @author winswe
 */
public class OTAutoCompleter implements KeyListener {
    static Logger log = Logger.getLogger(OTAutoCompleter.class.getName());
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private OTAutoCompleteTableModel acTableModel;
    private OTProcedure selService;
    private AbstractCellEditor editor;
    private TableRowSorter<TableModel> sorter;
    
    public OTAutoCompleter(JTextComponent comp, List<OTProcedure> list,
            AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(new java.awt.Font("Zawgyi-One", 0, 11));
        acTableModel = new OTAutoCompleteTableModel(list);
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            OTAutoCompleter completer = (OTAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);
    ...
    public OTProcedure getSelService() {
        return selService;
    }

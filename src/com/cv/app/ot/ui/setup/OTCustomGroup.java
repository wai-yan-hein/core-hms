...
import com.cv.app.ot.ui.common.OTCusGroupTableModel;
import com.cv.app.ot.ui.common.OTCusGroupDetailTableModel;
 ...
 * @author PHSH MDY
 */
public class OTCustomGroup extends javax.swing.JDialog {

    static Logger log = Logger.getLogger(OTCustomGroup.class.getName());
    private final OTCusGroupTableModel oclgTableModel = new OTCusGroupTableModel();
    private final OTCusGroupDetailTableModel oclgdTableModel = new OTCusGroupDetailTableModel();
    private final AbstractDataAccess dao = Global.dao;

    /**
     * Creates new form OPDCustomGroup
     */
    public OTCustomGroup() {
    ...
    private void initTable() {
        try {
            List<OTCusGroup> listOCLG = dao.findAllHSQL("select o from OTCusGroup o order by o.groupName");
            ...
            tblCusGroup.getSelectionModel().addListSelectionListener(
                ...
                public void valueChanged(ListSelectionEvent e) {
                    ...
                    if (selectRow >= 0) {
                        OTCusGroup group = oclgTableModel.getSelectGroup(selectRow);
                        if(group != null){
                            int groupId = -1;
                            if(group.getId() != null){
                                groupId = group.getId();
            ...
            BindingUtil.BindCombo(cboOPDCat, dao.findAllHSQL("select o from OTProcedureGroup o order by o.groupName"));
    ...
    private final Action actionItemDeleteC = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (row >= 0) {
                OTCusGroupDetail oclgd = oclgdTableModel.getSelectData(row);
                if(oclgd.getKey().getCusGrpId() != null){
                    ...
                    oclgdTableModel.deleteItem(row, oclgd.getKey().getOpdCatId().getGroupId());
                }
            }
        }
    };

 ...
 * @author winswe
 */
public class SessionCheckOPDView extends AbstractView {

    @Override
    protected JComponent createControl() {
        String propValue = Util1.getPropValue("system.opd.session.check");
        if(propValue.isEmpty()){
            return new SessionCheckOPD();
        }
        return new SessionCheckOPDPhar();
    }

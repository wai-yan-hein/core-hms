...
import com.cv.app.opd.ui.common.OPDCategoryListTableModel;
 ...
 * @author winswe
 */
public class OPDCategoryAutoCompleter implements KeyListener {

    static Logger log = Logger.getLogger(OPDCategoryAutoCompleter.class.getName());
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private OPDCategoryListTableModel acTableModel;
    private OPDCategory selService;
    private AbstractCellEditor editor;
    private TableRowSorter<TableModel> sorter;

    public OPDCategoryAutoCompleter(JTextComponent comp, List<OPDCategory> list,
            AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(new java.awt.Font("Zawgyi-One", 0, 11));
        acTableModel = new OPDCategoryListTableModel(list);
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            OPDCategoryAutoCompleter completer = (OPDCategoryAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

            if (completer.table.getSelectedRow() != -1) {
                selService = acTableModel.getOPDCategory(completer.table.convertRowIndexToModel(
    ...
    public OPDCategory getSelCategory() {
        return selService;
    }

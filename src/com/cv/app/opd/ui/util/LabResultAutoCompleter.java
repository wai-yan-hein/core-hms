 ...
 * @author winswe
 */
public class LabResultAutoCompleter implements KeyListener {
    static Logger log = Logger.getLogger(LabResultAutoCompleter.class.getName());
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private AutoCompleteTextTableModel acTableModel = new AutoCompleteTextTableModel();
    private LabResultAutoText selService;
    private AbstractCellEditor editor;
    private TableRowSorter<TableModel> sorter;
    
    public LabResultAutoCompleter(JTextComponent comp, List<LabResultAutoText> list,
            AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(new java.awt.Font("Zawgyi-One", 0, 15));
        acTableModel.setListLRAT(list);
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            LabResultAutoCompleter completer = (LabResultAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

            if (completer.table.getSelectedRow() != -1) {
                selService = acTableModel.getResultText(completer.table.convertRowIndexToModel(
    ...
    private void showPopup() {
        if (!popup.isVisible()) {
            ...
            if (textComp.isEnabled()) {
                ...
                popup.show(textComp, x+440, textComp.getHeight());
            } else {
                popup.setVisible(false);
            }
        }
    ...
    public LabResultAutoText getSelService() {
        return selService;
    }

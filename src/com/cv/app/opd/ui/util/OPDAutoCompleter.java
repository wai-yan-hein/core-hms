 ...
 * @author winswe
 */
public class OPDAutoCompleter implements KeyListener {

    static Logger log = Logger.getLogger(OPDAutoCompleter.class.getName());
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private OPDAutoCompleteTableModel acTableModel;
    private Service selService;
    private AbstractCellEditor editor;
    private TableRowSorter<TableModel> sorter;

    public OPDAutoCompleter(JTextComponent comp, List<Service> list,
            AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(new java.awt.Font("Zawgyi-One", 0, 11));
        acTableModel = new OPDAutoCompleteTableModel(list);
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            OPDAutoCompleter completer = (OPDAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

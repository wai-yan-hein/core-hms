...
import com.cv.app.opd.ui.common.PackageItemAutoCompleteTableModel;
 ...
 * @author winswe
 */
public class PackageItemAutoCompleter implements KeyListener {

    static Logger log = Logger.getLogger(PackageItemAutoCompleter.class.getName());
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private PackageItemAutoCompleteTableModel acTableModel;
    private VUnionItem selItem;
    private AbstractCellEditor editor;
    private TableRowSorter<TableModel> sorter;

    public PackageItemAutoCompleter(JTextComponent comp, AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(new java.awt.Font("Zawgyi-One", 0, 11));
        acTableModel = new PackageItemAutoCompleteTableModel();
        ...
        table.getColumnModel().getColumn(2).setPreferredWidth(150);//Fees
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            PackageItemAutoCompleter completer = (PackageItemAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

            if (completer.table.getSelectedRow() != -1) {
                selItem = acTableModel.getItem(completer.table.convertRowIndexToModel(
    ...
    private RowFilter<Object, Object> startsWithFilter = new RowFilter<Object, Object>() {
        ...
        public boolean include(RowFilter.Entry<? extends Object, ? extends Object> entry) {
            ...
            String tmp3 = entry.getStringValue(2).toUpperCase();
            String text = textComp.getText().toUpperCase();

            if (tmp1.startsWith(text) || tmp2.startsWith(text) || tmp3.startsWith(text)) {
                return true;
            } else {
                return false;
            }

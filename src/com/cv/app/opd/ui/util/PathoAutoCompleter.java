 ...
 * @author winswe
 */
public class PathoAutoCompleter implements KeyListener {

    static Logger log = Logger.getLogger(PathoAutoCompleter.class.getName());
    ...
    public PathoAutoCompleter(JTextComponent comp,
        ...
        table.getColumnModel().getColumn(1).setPreferredWidth(80);//Rank
        table.getColumnModel().getColumn(2).setPreferredWidth(30);//Post
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            PathoAutoCompleter completer = (PathoAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

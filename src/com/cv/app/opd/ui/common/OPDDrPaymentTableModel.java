 ...
 * @author WSwe
 */
public class OPDDrPaymentTableModel extends AbstractTableModel {

    private List<OPDDrPayment> listDP = new ArrayList();
    private final String[] columnNames = {"Date", "Vou No", "Reg No", "Patient Name",
        "Admission No", "Service Name", "Qty", "Price", "Charge Type","Amount", "MO Fee", "Staff Fee",
        "Tech Fee", "Refer Fee", "Reader Fee"};

...
import com.cv.app.opd.database.view.VSessionClinicPhar;
 ...
 * @author WSwe
 */
public class SessionCheckOPDPharTableModel extends AbstractTableModel{
    private List<VSessionClinicPhar> listSVSessionClinic = new ArrayList();
    private List<VSessionClinicPhar> listVSessionClinic = new ArrayList();
    ...
    public Object getValueAt(int row, int column) {
        VSessionClinicPhar record = listVSessionClinic.get(row);
    ...
    public List<VSessionClinicPhar> getListVSessionClinic() {
        return listSVSessionClinic;
    }

    public void setListVSessionClinic(List<VSessionClinicPhar> listVSessionClinic) {
        this.listSVSessionClinic = listVSessionClinic;
        //fireTableDataChanged();
    }
    
    public VSessionClinicPhar getVSessionClinic(int row){

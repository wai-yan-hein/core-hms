 ...
 * @author winswe
 */
public class LabReferWithDoctorExcel extends GenExcel {

    static Logger log = Logger.getLogger(LabReferWithDoctorExcel.class.getName());
    private final AbstractDataAccess dao;
    private final String fileName;

    public LabReferWithDoctorExcel(AbstractDataAccess dao, String fileName) {
        super(dao);
        this.dao = dao;

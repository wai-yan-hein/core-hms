 ...
 * @author winswe
 */
public class LabReaderWithDoctorSeinExcel extends GenExcel {

    static Logger log = Logger.getLogger(LabReaderWithDoctorSeinExcel.class.getName());
    private final AbstractDataAccess dao;
    private final String fileName;

    public LabReaderWithDoctorSeinExcel(AbstractDataAccess dao, String fileName) {
        super(dao);
        this.dao = dao;
    ...
    public void genExcel() {
        ...
        try {
            ...
            listHeader.add("OPD Read Fee");
            listHeader.add("IPD Read Fee");

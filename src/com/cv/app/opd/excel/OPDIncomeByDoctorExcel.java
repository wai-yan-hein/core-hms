 ...
 * @author winswe
 */
public class OPDIncomeByDoctorExcel extends GenExcel {
    static Logger log = Logger.getLogger(OPDIncomeByDoctorExcel.class.getName());
    private final AbstractDataAccess dao;
    private final String fileName;
    
    public OPDIncomeByDoctorExcel(AbstractDataAccess dao, String fileName){
        super(dao);
        this.dao = dao;

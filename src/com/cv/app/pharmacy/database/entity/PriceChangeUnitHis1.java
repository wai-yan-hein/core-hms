...
public class PriceChangeUnitHis1 implements java.io.Serializable{
    ...
    private Double ePriceOld;
    private Double ePriceNew;
    
    public PriceChangeUnitHis1(){}
    
    public PriceChangeUnitHis1(ItemUnit pcUnit, Double nPriceOld, Double aPriceOld,
            Double bPriceOld, Double cPriceOld, Double dPriceOld, Double ePriceOld){
        this.pcUnit = pcUnit;
    ...
    @Column(name="e_price_old")
    public Double getePriceOld() {
        return ePriceOld;
    }

    public void setePriceOld(Double ePriceOld) {
        this.ePriceOld = ePriceOld;
    }

    @Column(name="e_price_new")
    public Double getePriceNew() {
        return ePriceNew;
    }

    public void setePriceNew(Double ePriceNew) {
        this.ePriceNew = ePriceNew;
    }
}

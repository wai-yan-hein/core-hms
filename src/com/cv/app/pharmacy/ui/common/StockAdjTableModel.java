...
public class StockAdjTableModel extends AbstractTableModel {
    ...
    private float getBalance(String locId, String medId) {
        ...
        strSql = "select * from (\n"
                ...
                + "       and sh.sale_date between var_op_date and v_tran_date \n"
                ...
                + "       and ph.pur_date between var_op_date and v_tran_date \n"
                ...
                + "       and rih.ret_in_date between var_op_date and v_tran_date \n"
                ...
                + "       and roh.ret_out_date between var_op_date and v_tran_date \n"
                ...
                + "       and th.tran_date between var_op_date and v_tran_date and tdh.med_id = prm_med_id\n"
                ...
                + "       and ah.adj_date between var_op_date and v_tran_date and adh.med_id = prm_med_id\n"
                ...
                + "	  and srh.deleted = false and srh.receive_date between var_op_date and v_tran_date and srdh.order_med_id = prm_med_id\n"
                ...
                + "	  and sih.deleted = false and sih.issue_date between var_op_date and v_tran_date \n"
                ...
                + "	 from v_damage vd\n"
                + "	where vd.deleted = false and vd.dmg_date between var_op_date and v_tran_date \n"

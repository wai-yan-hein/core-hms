 ...
 * @author winswe
 */
public class StockBalTableModel1 extends AbstractTableModel {
    
    static Logger log = Logger.getLogger(StockBalTableModel1.class.getName());
        ...
        try {
            ...
            switch (column) {
                ...
                case 3: //Deman
                    ...
                    record.setBalance(getBalance(record));
                    break;
                case 4: //FOC
                    if (value != null && !value.toString().isEmpty()) {
                        String medId = record.getMed().getMedId();

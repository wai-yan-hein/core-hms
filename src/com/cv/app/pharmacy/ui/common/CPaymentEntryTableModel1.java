...
import static com.cv.app.pharmacy.ui.common.CPaymentEntryTableModel.LOGGER;
 ...
 * @author lenovo
 */
public class CPaymentEntryTableModel1 extends AbstractTableModel {

    static Logger LOGGER = Logger.getLogger(OPDTableModel.class.getName());
    private List<VoucherPayment> listVP = new ArrayList();
    private final String[] columnNames = {"Cus-No", "Cus-Name", "Vou No.", "Vou Date",
        "Due Date", "Overdue", "Vou Total", "Ttl Paid", "Paid", "Discount", "Vou Balance", "FP"};

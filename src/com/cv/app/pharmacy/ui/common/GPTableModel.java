 ...
 * @author WSwe
 */
public class GPTableModel extends AbstractTableModel {

    static Logger log = Logger.getLogger(GPTableModel.class.getName());
    private List<VGrossProfit> listGrossProfit = new ArrayList();
    private final String[] columnNames = {"Code", "Description", "Packing-Size", "OP-Value",
        "TTL-Pur", "CL-Value", "COGS", "TTL-Sale",
        "Gross Profit"};

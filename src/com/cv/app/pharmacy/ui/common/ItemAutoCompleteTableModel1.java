 ...
 * @author WSwe
 */
public class ItemAutoCompleteTableModel1 extends AbstractTableModel {

    static Logger log = Logger.getLogger(ItemAutoCompleteTableModel1.class.getName());
    ...
    public ItemAutoCompleteTableModel1(List<VMedicine1> listItem) {

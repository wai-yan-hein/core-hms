...
import com.cv.app.pharmacy.ui.common.LocationTraderMappingTableModel;
 ...
 * @author winswe
 */
public class LocationCustomerMappingSetup extends javax.swing.JPanel {

    static Logger log = Logger.getLogger(MachinePropSetup.class.getName());
    private final AbstractDataAccess dao = Global.dao;
    private final LocationTraderMappingTableModel mappingTableModel = new LocationTraderMappingTableModel();
     ...
     */
    public LocationCustomerMappingSetup() {
        initComponents();
        try {
            dao.open();
            initCombo();
    ...
    private void initItemLocationTable() {
        ...
        tblMapping.getColumnModel().getColumn(4).setPreferredWidth(200);
        tblMapping.getColumnModel().getColumn(5).setPreferredWidth(10);
    }
    ...
    private void getItemLocationMapping() {
        String strSql = "select o from VLocationTraderMapping o where (o.key.locationId = "
                ...
                + "or o.key.locationId = -1) and o.traderType = 'C'";
        ...
        if (cboTownship.getSelectedItem() instanceof Township) {
            int townshipId = ((Township) cboTownship.getSelectedItem()).getTownshipId();
            strSql = strSql + " and o.townshipId = " + townshipId;
        }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cboTownship, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)

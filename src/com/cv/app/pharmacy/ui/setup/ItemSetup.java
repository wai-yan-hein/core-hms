 ...
 */
public class ItemSetup extends javax.swing.JPanel implements SelectionObserver, FormAction,
        KeyPropagate {

    static Logger log = Logger.getLogger(ItemSetup.class.getName());
        ...
        /*if (txtItemCode.getText().trim().equals("")) {
         ...
         txtItemCode.requestFocusInWindow();
            ...
            try {
                ...
                currMedicine.setPs((PharmacySystem) cboSystem.getSelectedItem());
            } catch (Exception ex) {
    ...
    private RowFilter<Object, Object> inStringFilter = new RowFilter<Object, Object>() {
        @Override
        public boolean include(RowFilter.Entry<? extends Object, ? extends Object> entry) {
            if (NumberUtil.isNumber(txtSearch.getText())) {
                int result = entry.getStringValue(0).toUpperCase().indexOf(txtSearch.getText().toUpperCase());
                if (result == -1) {
                    return false;
                } else {
                    return true;
                ...
                int result = entry.getStringValue(1).toUpperCase().indexOf(
                        txtSearch.getText().toUpperCase());
                if (result == -1) {
                    return false;
                } else {
            ...
            try {
                ...
                try ( CSVReader csvReader = new CSVReader(reader)) {
                    ...
                    while ((nextRecord = csvReader.readNext()) != null) {
                        ...
                        ttlRec++;
                        log.info("getNewMedCode : " + medCode + " : " + medName + " Cnt : " + ttlRec);
                        ...
                        try {
                            ...
                            log.error("err : " + medName + " : " + ex.toString());
                        }
                    }
    ...
    private void initComponents() {
        ...
        txtChemicalName.setFont(Global.textFont);

        jLabel7.setFont(Global.lableFont);
        jLabel7.setText("Unit Relation");

        txtUnitRelation.setEditable(false);
        txtUnitRelation.setFont(Global.textFont);
        ...
        cboSystem.setFont(Global.textFont);

        butSystem.setText("...");
        butSystem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                butSystemActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtShortName, javax.swing.GroupLayout.PREFERRED_SIZE, 416, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(cboSystem, javax.swing.GroupLayout.PREFERRED_SIZE, 352, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(butSystem, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                                .addContainerGap())
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel1, jLabel10, jLabel12, jLabel2, jLabel3, jLabel4, jLabel5, jLabel6, jLabel7, jLabel8, jLabel9});
  ...
  private void txtItemNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtItemNameActionPerformed
    ...
    private javax.swing.JButton butSystem;

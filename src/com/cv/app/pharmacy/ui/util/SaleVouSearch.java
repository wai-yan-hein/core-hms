 ...
 * @author WSwe
 */
public class SaleVouSearch extends javax.swing.JPanel implements SelectionObserver {

    static Logger log = Logger.getLogger(SaleVouSearch.class.getName());
     ...
     */
    public SaleVouSearch(Object parent, SelectionObserver observer, AbstractDataAccess dao) {
        initComponents();
        ...
        try {
            ...
            if (tmpFilter == null) {
                ...
                if (vouFilter.getTrader() != null) {
                    traderId = vouFilter.getTrader().getTraderId();
                    if (Util1.getPropValue("system.sale.emitted.prifix").equals("Y")) {
                        txtCusCode.setText(vouFilter.getTrader().getStuCode());
                    } else {
                        txtCusCode.setText(traderId);
                    }
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(txtCusName, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE))
                            .addComponent(cboLocation, 0, 217, Short.MAX_VALUE)
                            .addComponent(cboSession, 0, 217, Short.MAX_VALUE)
                            .addComponent(cboPayment, 0, 217, Short.MAX_VALUE)
                            .addComponent(txtVouNo, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
                            .addComponent(cboCusGroup, 0, 217, Short.MAX_VALUE)
                            .addComponent(cboVStatus, 0, 217, Short.MAX_VALUE)
                            .addComponent(txtRemark, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()

 ...
 * @author winswe
 */
public class BusinessTypeAutoCompleter implements KeyListener {
    static Logger log = Logger.getLogger(BusinessTypeAutoCompleter.class.getName());
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private BusinessTypeAutoCompleteTableModel acTableModel;
    private BusinessType selBusinessType;
    ...
    public BusinessTypeAutoCompleter(JTextComponent comp, List<BusinessType> list,
        ...
        acTableModel = new BusinessTypeAutoCompleteTableModel(list);
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (completer.table.getSelectedRow() != -1) {
                selBusinessType = acTableModel.getBusinessType(completer.table.convertRowIndexToModel(
                        completer.table.getSelectedRow()));
                ((JTextField) completer.textComp).setText(selBusinessType.getDescription());
            }
    ...
    public BusinessType getSelBusinessType() {
        return selBusinessType;
    }

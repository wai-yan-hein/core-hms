...
import com.cv.app.pharmacy.ui.common.TownshipAutoCompleteTableModel;
 ...
 * @author winswe
 */
public class TownshipAutoCompleter implements KeyListener {
    static Logger log = Logger.getLogger(TownshipAutoCompleter.class.getName());
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private TownshipAutoCompleteTableModel acTableModel;
    private Township selTownship;
    private AbstractCellEditor editor;
    private final TableRowSorter<TableModel> sorter;

    public TownshipAutoCompleter(JTextComponent comp, List<Township> list,
            AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(new java.awt.Font("Zawgyi-One", 0, 11));
        acTableModel = new TownshipAutoCompleteTableModel(list);
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            TownshipAutoCompleter completer = (TownshipAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

            if (completer.table.getSelectedRow() != -1) {
                selTownship = acTableModel.getTownship(completer.table.convertRowIndexToModel(
                        completer.table.getSelectedRow()));
                ((JTextField) completer.textComp).setText(selTownship.getTownshipName());
            }
    ...
    public Township getSelTownship() {
        return selTownship;
    }

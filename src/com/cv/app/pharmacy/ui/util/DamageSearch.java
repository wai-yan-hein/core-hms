 ...
 * @author WSwe
 */
public class DamageSearch extends javax.swing.JPanel implements SelectionObserver {

    static Logger log = Logger.getLogger(DamageSearch.class.getName());
    private final AbstractDataAccess dao = Global.dao;
    private Object parent;
    private SelectionObserver observer;
    private int selectedRow = -1;
    private CodeTableModel tblMedicineModel = new CodeTableModel(Global.dao, true, "DmgSearch");
    private DamageSearchTableModel vouTableModel = new DamageSearchTableModel();
     ...
     */
    public DamageSearch(Object parent, SelectionObserver observer, AbstractDataAccess dao) {
        initComponents();
        ...
        try {
            ...
            log.error("DamageSearch : " + ex.getStackTrace()[0].getLineNumber() + " - " + ex.toString());
        }
    ...
    private void initTableVoucher() {
         ...
         * listDmg, tblVoucher); JTableBinding.ColumnBinding columnBinding =
         * jTableBinding.addColumnBinding(org.
         * jdesktop.beansbinding.ELProperty.create("${dmgDate}"));
         * columnBinding.setColumnName("Date");
         * columnBinding.setColumnClass(Date.class);
         * columnBinding.setEditable(false);
         *
         * columnBinding =
         * jTableBinding.addColumnBinding(ELProperty.create("${dmgVouId}"));
         ...
         *
         * columnBinding =
         * jTableBinding.addColumnBinding(ELProperty.create("${remark}"));
    ...
    private String getHSQL() {
        /*String strSql = "select distinct v from DamageHis v join v.listDetail h where v.dmgDate between '"
                + DateUtil.toDateStrMYSQL(txtFromDate.getText()) + "' and '"
                + DateUtil.toDateStrMYSQL(txtToDate.getText()) + "'";*/
        String strSql = "select distinct date(sh.dmg_date) dmg_date, sh.dmg_id, sh.remark, \n"
                + "usr.user_name, l.location_name, sh.deleted\n"
                + "from dmg_his sh\n"
                + "join dmg_detail_his sdh on sh.dmg_id = sdh.vou_no\n"
                ...
                + "where sh.dmg_date between '" + DateUtil.toDateTimeStrMYSQL(txtFromDate.getText()) + "' and '"
        ...
        if (txtVouNo.getText() != null && !txtVouNo.getText().isEmpty()) {
            strSql = strSql + " and sh.dmg_id = '" + txtVouNo.getText() + "'";
        }
    ...
    private void select() {
        if (selectedRow >= 0) {
            ...
            JOptionPane.showMessageDialog(Util1.getParent(), "Please select damage voucher.",
    ...
    private void initComponents() {
        ...
        txtDesp.setFont(new java.awt.Font("Zawgyi-One", 0, 11)); // NOI18N

    ...
    private void getData() {
        try {
            ...
            String strSql = "select a.*, if(a.ttl_overdue<0,0,a.ttl_overdue) as ttl_overdue1 from (\n"
                    ...
                    + "	 join (select discriminator, trader_id, trader_name, ifnull(group_id,sys_prop_value) as group_id, t.credit_days, t.stu_no\n" 
                    + "          from trader t, (select sys_prop_value from sys_prop where sys_prop_desp = 'system.cus.base.group') a) t on vob.trader_id = t.trader_id\n"
                    ...
                    + "  join (select discriminator, trader_id, trader_name, ifnull(group_id,sys_prop_value) as group_id, t.credit_days, t.stu_no\n" 
                    + "  from trader t, (select sys_prop_value from sys_prop where sys_prop_desp = 'system.cus.base.group') a) t on bth.trader_id = t.trader_id\n"
                    + "	 left join customer_group cg on t.group_id = cg.group_id\n"

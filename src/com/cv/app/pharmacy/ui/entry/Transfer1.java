...
import com.cv.app.pharmacy.ui.common.TransferTableModel1;
 ...
 * @author WSwe
 */
public class Transfer1 extends javax.swing.JPanel implements SelectionObserver, FormAction,
        MedInfo, KeyPropagate {

    static Logger log = Logger.getLogger(Transfer1.class.getName());
    ...
    private TransferTableModel1 tblTransferModel = new TransferTableModel1(listDetail, dao,
            medUp, this, this);
    ...
    public Transfer1(List<ReOrderLevel> listReOrderLevel, Location from, Location to) {
        initComponents();
    ...
    private void initTransferItem(List<ReOrderLevel> listReOrderLevel) {
        listDetail = new ArrayList();

        try {
            for (ReOrderLevel rol : listReOrderLevel) {
    ...
    private void initTransferTable() {
        ...
        tblTransfer.getColumnModel().getColumn(6).setPreferredWidth(15);//Foc
        ...
        tblTransfer.getColumnModel().getColumn(9).setPreferredWidth(30);//Disc %
        tblTransfer.getColumnModel().getColumn(10).setPreferredWidth(35);//Discount
        tblTransfer.getColumnModel().getColumn(11).setPreferredWidth(50);//Amount

        tblTransfer.getColumnModel().getColumn(5).setCellEditor(new BestTableCellEditor());
        tblTransfer.getColumnModel().getColumn(8).setCellEditor(new BestTableCellEditor());
        tblTransfer.getColumnModel().getColumn(9).setCellEditor(new BestTableCellEditor());
        tblTransfer.getColumnModel().getColumn(10).setCellEditor(new BestTableCellEditor());

        tblTransfer.getColumnModel().getColumn(4).setCellRenderer(rightRenderer);
        tblTransfer.getColumnModel().getColumn(5).setCellRenderer(rightRenderer);
        tblTransfer.getColumnModel().getColumn(6).setCellRenderer(rightRenderer);
    ...
    private void assignCustomer(Trader pTrader) {
        ...
        if (cus == null) {
            ...
            if (cus.getTypeId() != null) {
                tblTransferModel.setCusType(cus.getTypeId().getDescription());
            } else {
                tblTransferModel.setCusType("N");
            }
        }
    ...
    private void uploadToAccountSale(TransferHis th) {
            ...
            if (Global.mqConnection != null) {
                if (Global.mqConnection.isStatus()) {
                    try {
                        ...
                        msg.setString("entity", "TRANSALE");
                        msg.setString("vouNo", th.getTranVouId());
                        msg.setString("remark", th.getRemark());
                        Trader trader = (Trader) dao.find(Trader.class, th.getCusId());
                        msg.setString("cusId", trader.getAccountId());
                        msg.setString("saleDate", DateUtil.toDateStr(th.getTranDate(), "yyyy-MM-dd"));
                        msg.setBoolean("deleted", false);
                        //msg.setDouble("vouTotal", sh.getVouTotal() + sh.getTtlExpenseIn() + sh.getExpenseTotal());
                        msg.setDouble("vouTotal", th.getVouTotal());
                        msg.setDouble("discount", 0);
                        msg.setDouble("payment", 0);
                        msg.setDouble("tax", 0);
                    ...
                    log.error("Connection status error : " + th.getTranVouId());
                }
            } else {
                log.error("Connection error : " + th.getTranVouId());
            }
        }
    }

    private void uploadToAccountPurchase(TransferHis th) {
        String isIntegration = Util1.getPropValue("system.integration");
        if (isIntegration.toUpperCase().equals("Y")) {
            if (!Global.mqConnection.isStatus()) {
                String mqUrl = Util1.getPropValue("system.mqserver.url");
            ...
            if (Global.mqConnection != null) {
                if (Global.mqConnection.isStatus()) {
                    try {
                        ...
                        MapMessage msg = mq.getMapMessageTemplate();
                        msg.setString("program", Global.programId);
                        msg.setString("entity", "TRANPURCHASE");
                        msg.setString("vouNo", th.getTranVouId());
                        msg.setString("remark", th.getRemark());
                        msg.setString("purDate", DateUtil.toDateStr(th.getTranDate(), "yyyy-MM-dd"));
                        Trader trader = (Trader) dao.find(Trader.class, th.getSupId());
                        msg.setString("cusId", trader.getAccountId());
                        msg.setBoolean("deleted", false);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(txtVouNo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 197, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(18, 18, 18)
                        .add(jLabel2)
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .add(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(cboFromLocation, 0, 169, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, cboToLocation, 0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .add(6, 6, 6)
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel4Layout.createSequentialGroup()
                        .add(jLabel8)
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(txtSupName, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE))
                    .add(jPanel4Layout.createSequentialGroup()
                        .add(jLabel4)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(txtCusId, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 100, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(txtCusName, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jPanel4Layout.linkSize(new java.awt.Component[] {jLabel6, jLabel7}, org.jdesktop.layout.GroupLayout.HORIZONTAL);

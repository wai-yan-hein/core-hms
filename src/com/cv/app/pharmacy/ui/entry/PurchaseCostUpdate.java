 ...
 * @author winswe
 */
public class PurchaseCostUpdate extends javax.swing.JPanel implements SelectionObserver {

    static Logger log = Logger.getLogger(PurchaseCostUpdate.class.getName());

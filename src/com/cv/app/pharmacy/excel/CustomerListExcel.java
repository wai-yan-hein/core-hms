 ...
 * @author winswe
 */
public class CustomerListExcel extends GenExcel {

    static Logger log = Logger.getLogger(CustomerListExcel.class.getName());
    private final AbstractDataAccess dao;
    private final String fileName;

    public CustomerListExcel(AbstractDataAccess dao, String fileName) {
        super(dao);
        this.dao = dao;

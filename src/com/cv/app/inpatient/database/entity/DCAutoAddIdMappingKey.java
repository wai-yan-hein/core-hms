 ...
 */
@Embeddable
public class DCAutoAddIdMappingKey implements Serializable{
    private String tranOption;
    private Integer tranServiceId;
    private InpService addServiceId;
    ...
    public InpService getAddServiceId() {
        return addServiceId;
    }

    public void setAddServiceId(InpService addServiceId) {
    ...
    public boolean equals(Object obj) {
        ...
        final DCAutoAddIdMappingKey other = (DCAutoAddIdMappingKey) obj;

 ...
 */
@Embeddable
public class DCVouSrvFilterKey implements Serializable{
    private String tranOption;
    private String userId;
    private InpService service;

    public DCVouSrvFilterKey(){}
    
    public DCVouSrvFilterKey(String tranOption, String userId, InpService service){

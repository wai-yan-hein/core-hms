...
import com.cv.app.inpatient.ui.common.DCAutoCompleteTableModel;
 ...
 * @author winswe
 */
public class DCAutoCompleter implements KeyListener {
    static Logger log = Logger.getLogger(DCAutoCompleter.class.getName());
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private DCAutoCompleteTableModel acTableModel;
    private InpService selService;
    private AbstractCellEditor editor;
    private final TableRowSorter<TableModel> sorter;
    
    public DCAutoCompleter(JTextComponent comp, List<InpService> list,
            AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(new java.awt.Font("Zawgyi-One", 0, 11));
        acTableModel = new DCAutoCompleteTableModel(list);
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            DCAutoCompleter completer = (DCAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

            if (completer.table.getSelectedRow() != -1) {
                selService = acTableModel.getService(completer.table.convertRowIndexToModel(
    ...
    public InpService getSelService() {
        return selService;
    }
